...
#
#     PHX_SERVER=true bin/terra_mystica start
#
...
if config_env() == :prod do
  ...
  config :terra_mystica, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :terra_mystica, TerraMystica.Mailer,
